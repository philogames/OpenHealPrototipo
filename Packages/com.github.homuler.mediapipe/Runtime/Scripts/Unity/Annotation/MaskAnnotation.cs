...
#pragma warning restore IDE0065
  ...
  public class MaskAnnotation : HierarchicalAnnotation
  {
    ...
    [SerializeField] public Material maskOffMaterial;
    [SerializeField] public Texture2D _maskTexture;
    [SerializeField] public Color _color = Color.blue;
    [SerializeField, Range(0, 1)] public float _threshold = 0.9f;
    bool MaskOn = true;
    ...
    public void ApplyMaskTexture(Texture maskTexture, Color maskColor)
    {
      if (_material != null)
      {
