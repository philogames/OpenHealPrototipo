...
namespace Mediapipe.Unity
{
  public class WebCamSource : ImageSource
  {
    ...
    private ResolutionStruct[] _defaultAvailableResolutions = new ResolutionStruct[] {
     new ResolutionStruct(160, 120, 30),
      new ResolutionStruct(192, 144, 30),
      new ResolutionStruct(176, 144, 30),
      new ResolutionStruct(240, 160, 30),
      new ResolutionStruct(352, 240, 30),
      new ResolutionStruct(352, 288, 30),
      new ResolutionStruct(384, 288, 30),
      new ResolutionStruct(480, 360, 30),
      new ResolutionStruct(704, 480, 30),
      new ResolutionStruct(720, 480, 30),
      new ResolutionStruct(800, 480, 30),
      new ResolutionStruct(800, 600, 30),
      new ResolutionStruct(960, 720, 30),
      new ResolutionStruct(1024, 768, 30),
      new ResolutionStruct(1200, 800, 30),
...
#pragma warning restore IDE0025
    ...
    {
            StartCoroutine(ChangeWebCam_Coroutine(index));
    }

    IEnumerator ChangeWebCam_Coroutine(int index)
    {
            // Stop capturing from the current webcam
        ...
        SelectSource(index);
         InitializeWebCamTexture();
            ...
            yield return new WaitForSeconds(0.1f);
            // Start capturing from the new webcam
        StartCoroutine(Play());
    ...
    public IEnumerator WaitForWebCamTexture()
    {
