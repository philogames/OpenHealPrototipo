...
namespace Mediapipe.Unity.PoseTracking
{
    ...
    public class PoseTrackingSolution : ImageSourceSolution<PoseTrackingGraph>
  {
    ...
    [SerializeField] public PoseLandmarkListAnnotationController _poseLandmarksAnnotationController;
    ...
    [SerializeField] public NormalizedRectAnnotationController _roiFromLandmarksAnnotationController;

        public event Action<NormalizedLandmarkList> OnPoseLandmarksUpdated;
    ...
    protected override IEnumerator WaitForNextValue()
    {
      ...
      if(poseLandmarks!= null)
            OnPoseLandmarksUpdated?.Invoke(poseLandmarks);
